...
const FetchNearbyPlaces = async (location, dispatch) => {
  try {
    let config = {
      ...
      url: `${Google_Base_Url}place/nearbysearch/json?location=${location?.latitude},${location.longitude}&radius=100000&type=restaurant&key=${Google_API_KEY}`,
      headers: {},
    };
    ...
    console.log(
      'Google url',
      `${Google_Base_Url}place/nearbysearch/json?location=${location?.latitude},${location.longitude}&radius=1000&type=restaurant&key=${Google_API_KEY}`,
    );
