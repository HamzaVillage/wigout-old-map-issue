    ...
    const GradientButton = ({ title, onPress }) => (
        <TouchableOpacity 
            ...
            <Svg height="60" width={width * 0.9} style={StyleSheet.absoluteFill}>
                ...
                <Rect x="0" y="0" width={width * 0.9} height="60" rx="30" fill="url(#grad)" />
            </Svg>
            <AppText
                title={title}
                textSize={2}
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => goBack()}>
                        <Ionicons name="arrow-back" size={28} color={AppColors.BTNCOLOURS} />
                    </TouchableOpacity>
                    <View style={{ width: 25 }} />
                    <AppText
                ...
                <View style={styles.content}>
                    <AppText
                        title={"Start by adding places you love and places you'd rather avoid. This helps us remind you of your experiences and warn you before making the same mistake twice!"}
                        textSize={1.9}
                        textColor="#47082E"
                        textAlignment="center"
                        lineHeight={2.8}
